			...
			<div className="max-w-4xl mx-auto">
				<div className="overflow-hidden p-6 flex flex-col items-center">
					...
					<p className="text-[var(--foreground)]/80 text-sm leading-relaxed mb-4 text-center max-w-2xl">
						A content-driven website built to showcase the client’s
						political and historical articles, while also
						highlighting consulting and security services. The
						platform is centered on dynamic article management:
						instead of hardcoding new pages, articles are stored as
						Markdown (.md) files that are parsed and rendered
						automatically, making publishing seamless without
						needing a backend.
					</p>
				...
				<div className="mt-8 text-[var(--foreground)] leading-relaxed max-w-none">
					...
					<div className="my-6">
						<p className="mb-2">
							...
							Dynamic Content: Articles stored as Markdown (.md)
							files and rendered automatically — no manual page
							creation needed
						</p>
						<p className="mb-2">
							<span className="text-[var(--primary)] font-bold mr-2">
						...
						<p className="mb-2">
							...
							setup to send messages directly to email inboxes (no
							backend required)
						</p>
						<p className="mb-2">
							<span className="text-[var(--primary)] font-bold mr-2">
							...
							SEO: Detailed alt text, keyword tagging, and
							structured descriptions for improved search ranking
							and accessibility
						</p>
						<p className="mb-2">
							<span className="text-[var(--primary)] font-bold mr-2">
					...
					<p className="text-[var(--foreground)] mb-4">
						This project demonstrates my ability to design and
						implement a content-focused site with modern tooling,
						SEO best practices, and practical integrations that
